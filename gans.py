...
def DCGAN_G(isize, nz, ngf):
    ...
    x = Conv2DTranspose(filters=ngf, kernel_size=3, strides=2, use_bias=False, kernel_initializer = conv_init)(x)
    for _ in range(4):
...
nc = 3 # 3 color rgb for each img
nz = 100
ngf = 1024 # number of cnn filters for generator
ndf = 64 # number of cnn filters for discriminator
imageSize = 96 # 96*96
batchSize = 64
lrD = 0.00005 
lrG = 0.00005
